...
export class BaseDocumentHitElement extends BaseHitElement {
    ...
    render() {
        ...
        this.ariaLabel = `${i18n.t('custom:hitbox.document-entry')} ${this.lang === 'de' ? hit.file.base.additionalType.text : hit.file.base.additionalType.textEn} ${i18n.t('custom:hitbox.document-of')} ${hit.person.familyName}, ${hit.person.givenName}`;
                          ...
                          <header class="ais-doc-Hits-header">
                              ...
                              <div class="text-container">
                                  <h3
                                      ...
                                      aria-label="${i18n.t('custom:full-family-name')} ${hit.person
                                  ...
                                  <div
                                      ...
                                      aria-label="${i18n.t('custom:person.st-PersonNr')} ${hit.person.studId}">
                          ...
                          <main class="ais-doc-Hits-content">
                              <div class="hit-content-item">
                                  ...
                                  ${hit.file.base.subjectOf
                                      ...
                                      : ''}
                                  <span>
                                      ${i18n.t('custom:file.added')}:
                                      <strong>${dateCreated}</strong>
                                  </span>
                                  <span>${i18n.t('custom:file.last-modified')}: ${lastModified}</span>
                              </div>
                    ...
                    : html`
                          <main class="ais-doc-Hits-content">
                              <div>
                                  ...
                                  <strong>${dateCreated}</strong>
                                  ,
                                  <span>${i18n.t('custom:file.modified')} ${lastModified}</span>
                                  (${i18n.t('custom:file.obsolete')})
                                  <div class="hit-content-item">
                                      ${this._renderContent()}
                                      ${hit.file.base.subjectOf
                                          ? html`
