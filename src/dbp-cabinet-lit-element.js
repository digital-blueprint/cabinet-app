...
import * as cabinetHelper from './utils';
...
export default class DBPCabinetLitElement extends DBPLitElement {
    ...
    /**
     * Gets the list of all cabinet requests of the current logged-in user
     * @param groupId
     * @returns {object} response
     */
    async getListOfCabinetRequests(groupId) {
        const options = {
            method: 'GET',
            headers: {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/requests?perPage=999&groupId=' + groupId, options);
    }

    /**
     * Gets the cabinet request of the current logged-in user with the given identifier
     * @param identifier
     * @returns {object} response
     */
    async getCabinetRequest(identifier) {
        const options = {
            method: 'GET',
            headers: {
                'Content-Type': 'application/ld+json',
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/requests/' + identifier, options);
    }

    /**
     * Gets the cabinet recipient of the given ID
     * @param identifier
     * @returns {object} response
     */
    async getCabinetRecipient(identifier) {
        const options = {
            method: 'GET',
            headers: {
                'Content-Type': 'application/ld+json',
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-recipients/' + identifier, options);
    }
    ...
    /**
     * Sends a cabinet post request
     * @returns {object} response
     */
    async sendCreateCabinetRequest() {
        const i18n = this._i18n;
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/requests', options);
    }

    /**
     * Sends a delete cabinet request
     * @param identifier
     * @returns {object} response
     */
    async sendDeleteCabinetRequest(identifier) {
        const options = {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/ld+json',
     ...
     * @returns {object} response
     */
    async sendEditCabinetRequest(identifier, senderOrganizationName, senderFullName, senderAddressCountry, senderPostalCode, senderAddressLocality, senderStreetAddress, senderBuildingNumber, groupId) {
        const i18n = this._i18n;
    ...
    /**
     * Sends a submit cabinet request
     * @param identifier
     * @returns {object} response
     */
    async sendSubmitCabinetRequest(identifier) {
        let body = {};
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/requests/' + identifier + '/submit', options);
    }

    /**
     * Sends a cabinet request-recipients post request
     * @param id
    ...
    async sendAddRequestRecipientsRequest(id, personIdentifier, givenName, familyName, birthDate, addressCountry, postalCode, addressLocality, streetAddress) {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-recipients', options);
    }
    ...
    async sendUpdateRecipientRequest(recipientId, id, personIdentifier, givenName, familyName, birthDate, addressCountry, postalCode, addressLocality, streetAddress) {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-recipients/' + recipientId, options);
    }
    ...
    async sendDeleteRecipientRequest(id) {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-recipients/' + id, options);
    }

    async sendAddFileToRequest(id, file) {
        let formData = new FormData();
        formData.append('cabinetRequestIdentifier', id);
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-files', options);
    }
    ...
    async sendDeleteFileRequest(id) {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-files/' + id, options);
    }
     ...
     * @param identifier The identifier of the cabinet request
    ...
    async sendGetFileRequest(identifier) {
        ...
        return await this.httpGetAsync(this.entryPointUrl + '/cabinet/request-files/' + identifier, options);
    }

    async getCreatedCabinetRequests() {
        // const i18n = this._i18n;
        ...
        if (createdRequestsIds !== undefined) {
            for (let i = 0; i < createdRequestsIds.length; i++) {
                try {
                    let response = await this.getCabinetRequest(createdRequestsIds[i]);
                    ...
                    if (responseBody !== undefined && responseBody.status !== 403) {
                        ...
                        if (response.status === 500) {
                            send({
                                "summary": 'Error!',
                                "body": 'Could not fetch cabinet requests. Response code: 500',
                                "type": "danger",
                                "timeout": 5,
                            });
                    ...
                    send({
                        "summary": 'Error!',
                        "body": 'Could not fetch cabinet requests.',
                        "type": "danger",
                        "timeout": 5,
                    });
                }
        ...
        this.cabinetRequestsTable.replaceData(tableObject);
        this.cabinetRequestsTable.setLocale(this.lang);
        this.totalNumberOfItems = this.cabinetRequestsTable.getDataCount("active");
    ...
    */
    openFileSource() {
        ...
        if (this.singleFileProcessing && !this.requestCreated) {
            this.processCreateCabinetRequest().then(() => {
    ...
    async onFileSelected(event) {
        ...
        this.fileUploadFinished = false;
        if (!this.singleFileProcessing && !this.requestCreated) {
            this.processCreateCabinetRequest().then(async () => {
    ...
    async addFileToRequest(id, file) {
        ...
        if (responseBody !== undefined && response.status === 201) {
            ...
            let resp = await this.getCabinetRequest(id);
            ...
            if (this.uploadedNumberOfFiles === this.currentFileIndex && !this.addFileViaButton) {
                await this.getCreatedCabinetRequests();
            }
        } else {
            // TODO error handling
    ...
    async downloadFileClickHandler(fileContentUrl, fileName) {
        let files = [];
        const arr = cabinetHelper.convertDataURIToBinary(fileContentUrl);
        const binaryFile = new File([arr], fileName, {
            type: cabinetHelper.getDataURIContentType(fileContentUrl),
        });
    ...
    async addRecipientToRequest(button) {
        ...
        try {
            ...
            if (responseBody !== undefined && response.status === 201) {
                ...
                this.currentRecipient.addressCountry = cabinetHelper.getCountryMapping('AT');
    ...
    async fetchStatusOfRecipient(recipient) {
        let response = await this.getCabinetRecipient(recipient.identifier);
        let responseBody = await response.json();
        if (responseBody !== undefined && response.status === 200) {
    ...
    async editRequest(event, item) {
        ...
        try {
            let resp = await this.getCabinetRequest(item.identifier);
            let responseBody = await resp.json();
            if (responseBody !== undefined && responseBody.status !== 403) {
                this.currentItem = responseBody;
            }
    ...
    async deleteRequest(event, item) {
        ...
        if (confirm(i18n.t('show-requests.delete-dialog-text_one'))) {
            ...
            try {
                let response = await this.sendDeleteCabinetRequest(item.identifier);
                if (response.status === 204) {
    ...
    async submitRequest(event, item) {
        ...
        if(confirm(i18n.t('show-requests.submit-dialog-text'))) {
            try {
                ...
                let response = await this.sendSubmitCabinetRequest(item.identifier);
    ...
    async confirmEditSender() {
        ...
        try {
            ...
            let response = await this.sendEditCabinetRequest(id, senderOrganizationName, senderFullName, senderAddressCountry[0], senderPostalCode, senderAddressLocality, senderStreetAddress, senderBuildingNumber, groupId);
    ...
    async confirmAddSubject() {
        ...
        await this.processCreateCabinetRequest();
    ...
    async fetchDetailedRecipientInformation(identifier) {
        // if (this.mayReadAddress) {
            let response = await this.getCabinetRecipient(identifier);
    ...
    async submitSelected() {
        ...
        try {
            ...
            let selectedItems = this.cabinetRequestsTable.getSelectedRows();
            ...
            for (let i = 0; i < selectedItems.length; i++) {
                ...
                let response = await this.getCabinetRequest(id);
            ...
            let dialogText = i18n.t('show-requests.submit-dialog-text', {count: this.cabinetRequestsTable.getSelectedRows().length});
            ...
            if (confirm(dialogText)) {
                for (let i = 0; i < selectedItems.length; i++) {
                    ...
                    let submitResponse = await this.sendSubmitCabinetRequest(result.identifier);
    ...
    async deleteSelected() {
        ...
        try {
            ...
            let dialogText = i18n.t('show-requests.delete-dialog-text_other', {count: this.cabinetRequestsTable.getSelectedRows().length});
            ...
            if (confirm(dialogText)) {
                for (let i = 0; i < selectedItems.length; i++) {
                    ...
                    let deleteResponse = await this.sendDeleteCabinetRequest(result.identifier);
    ...
    async processCreateCabinetRequest() {
        this._('#create-btn').start();

        try {
            let response = await this.sendCreateCabinetRequest();
            let responseBody = await response.json();
    ...
    expandAll(event) {
        this.cabinetRequestsTable.getRows('visible').forEach(row => {
        ...
        setTimeout(function () {
            that.cabinetRequestsTable.redraw();
        }, 0);
    ...
    dataLoadedFunction(data) {
        if (this.cabinetRequestsTable !== null) {
            const that = this;
            setTimeout(function () {
    ...
    toggleCollapse(e) {
        ...
        const table = this.cabinetRequestsTable;
    ...
    rowClickFunction(e, row) {
        if (
            this.cabinetRequestsTable !== null &&
            this.cabinetRequestsTable.getSelectedRows().length ===
            this.cabinetRequestsTable.getRows("visible").length) {
        ...
        if (
            this.cabinetRequestsTable !== null &&
            this.cabinetRequestsTable.getSelectedRows().length > 0 ) {
    ...
    selectAllFiles() {
        ...
        if (allSelected) {
            this.cabinetRequestsTable.getSelectedRows().forEach((row) => row.deselect());
        } else {
            this.cabinetRequestsTable.getRows().forEach((row) => row.select());
            // this.cabinetRequestsTable.selectRow();
        }
    }

    checkAllSelected() {
        if (this.cabinetRequestsTable) {
            let maxSelected = this.cabinetRequestsTable.getRows("visible").length;
            let selected = this.cabinetRequestsTable.getSelectedRows().length;
            // console.log('currently visible: ', this.cabinetRequestsTable.getRows("visible").length);
            // console.log('currently selected: ', this.cabinetRequestsTable.getSelectedRows().length);
    ...
    async processSelectedSender(event) {
        ...
        if (event.target.valueObject.accessRights) {
            ...
            if (!mayWrite && !this.requestCreated) {
                ...
                let response = await this.sendEditCabinetRequest(this.currentItem.identifier, senderOrganizationName, senderFullName,
        ...
        if (this._('#recipient-selector') && this._('#recipient-selector').getAttribute('data-object') !== null && this._('#recipient-selector').getAttribute('data-object') !== '') {
            ...
            if (responseBody !== undefined && response.status === 200) {
                ...
                if (responseBody['localData'] !== null) {
                    ...
                    this.currentRecipient.addressCountry = responseBody['localData']['addressCountry'] ? cabinetHelper.getCountryMapping(responseBody['localData']['addressCountry']) : cabinetHelper.getCountryMapping('AT');
                }
            } else {
                // TODO error handling
            }
                                ...
                                <dbp-translated subscribe="lang">
                                    <div slot="de">
                                        <select required id="edit-sender-country-select" class="country-select">
                                                ${cabinetHelper.getGermanCountryList()}

                                        </select>
                                    </div>
                                    <div slot="en">
                                        <select required id="edit-sender-country-select" class="country-select">
                                                ${cabinetHelper.getEnglishCountryList()}
                                        </select>
                                    </div>
                                </dbp-translated>                                
                            </div>
        ...
        return html`
            <div class="details sender hidden">
                ...
                <div class="sender-data">
                    ...
                    ${this.currentItem.senderAddressCountry ? html`<br>${cabinetHelper.getCountryMapping()[this.currentItem.senderAddressCountry]}` : ``}
                </div>
    ...
    addRecipientCardLeftSideContent(recipient) {
        ...
        return html`
             <div class="left-side">
                ...
                <div>${cabinetHelper.getCountryMapping()[recipient.addressCountry]}</div>
                ...
                ` : ``}
                 ...
                 ${this.currentItem.dateSubmitted && recipient.lastStatusChange.cabinetStatus && recipient.lastStatusChange.cabinetStatus === 'failure' ? html`
                    <div class="cabinet-status"><span class="status-title">${i18n.t('show-requests.cabinet-status')}</span> <span class="status-red">${i18n.t('show-requests.failure')}</span></div>
                ` : ``}
                 ${this.currentItem.dateSubmitted && recipient.lastStatusChange.cabinetStatus && recipient.lastStatusChange.cabinetStatus === 'success'  ? html`
                    <div class="cabinet-status"><span class="status-title">${i18n.t('show-requests.cabinet-status')}</span> <span class="status-green">${i18n.t('show-requests.success')}</span></div>
                ` : ``}
                 ${this.currentItem.dateSubmitted && recipient.lastStatusChange.cabinetStatus && recipient.lastStatusChange.cabinetStatus === 'pending'  ? html`
                    <div class="cabinet-status"><span class="status-title">${i18n.t('show-requests.cabinet-status')}</span> <span>${i18n.t('show-requests.pending')}</span></div>
                ` : ``}
                 ${this.currentItem.dateSubmitted && recipient.lastStatusChange.cabinetStatus && recipient.lastStatusChange.cabinetStatus === 'unknown'  ? html`
                    <div class="cabinet-status"><span class="status-title">${i18n.t('show-requests.cabinet-status')}</span> <span class="status-orange">${i18n.t('show-requests.unknown')}</span></div>
                ` : ``}
            </div>
        `;
    }
    ...
    checkRecipientStatus(recipients) {
        ...
        for (let i = 0; i < recipients.length; i++) {
            ...
            if (recipient.lastStatusChange) {
                status = recipient.lastStatusChange.cabinetStatus;
            } else {
                status = 'unknown';
            }
            if (status === 'success') {
    ...
    storeGroupValue(value) {
        ...
        sessionStorage.setItem('dbp-cabinet-group-value', this.groupValue);
    }

    loadGroupValue() {
        this.groupValue = sessionStorage.getItem('dbp-cabinet-group-value');
