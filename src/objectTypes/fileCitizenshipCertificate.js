        ...
        return html`
            <form>
               <header class="ais-cit-Hits-header">
                <div class="ais-cit-Hits-header-items header-item1">${hit.person.fullName}</div>
                <div class="ais-cit-Hits-header-items header-item2">
                ...
                <div class="ais-cit-Hits-header-items header-item3">${hit.person.birthDate}</div>
                <div class="ais-cit-Hits-header-items header-item4">${hit.person.studId}</div>
                <div class="ais-cit-Hits-header-items header-item5">${hit.person.stPersonNr}</div>
                </header>
