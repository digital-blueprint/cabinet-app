...
export default class {
    ...
    getFacetsConfig() {
        ...
        return [
            ...
            { "groupId": "person", "schemaField": "person.exmatriculationStatus.text", "schemaFieldType": "checkbox", "facetOptions": { facet: { searchablePlaceholder: 'cabinet-search.search-placeholder-person-exmatriculation-status', showMore: false, showMoreLimit: showMoreLimitValue}}},
