...
export class Logo extends AdapterLitElement {
    constructor() {
        super();
    ...
    static get styles() {
        return css`
            ...
            #logo:focus path,
            #logo:hover path {
                fill: var(--dbp-content-surface) !important;
                transition: none;
            }
    ...
    render() {
        ...
        return html`
            <div id="logo" part="logo">
                <div id="claim" part="claim">
                    <div>${i18n.t('logo.word1')}</div>
                    <div>${i18n.t('logo.word2')}</div>
                    <div>${i18n.t('logo.word3')}</div>
                </div>
                <svg
                    id="img"
                    part="image"
                    ...
                    <g transform="matrix(1.25 0 0 -1.25 0 51.862)">
                        <g transform="scale(.1)">
                            <path
                                style="fill:var(--tugraz-logo-color)"
