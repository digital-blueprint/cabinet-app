...
export class BaseFormElement extends ScopedElementsMixin(CustomLitElement) {
    ...
    static getDisposalTypes(i18n, type) {
        ...
        return {
            archival: i18n.t(`custom:typesense-schema.file.base.disposalType.archival`),
            deletion: i18n.t(`custom:typesense-schema.file.base.disposalType.deletion`),
        };
    }
    ...
    static getIsPartOfItems(i18n) {
        ...
        return Object.fromEntries(
            items
                .map((item) => [item, i18n.t(`custom:typesense-schema.file.base.isPartOf.${item}`)])
...
export class BaseViewElement extends ScopedElementsMixin(CustomLitElement) {
    ...
    getStudyFieldNameForKey(key) {
        ...
        const studies = [
            {key: keyUnspecified, name: i18n.t('custom:doc-modal-study-field-unspecified')},
            ...(personData.studies || []),
        ];
        ...
        return i18n.t('custom:doc-modal-study-field-unknown', {studyFieldKey: key});
    }
