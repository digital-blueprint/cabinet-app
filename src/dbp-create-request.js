...
class CreateRequest extends ScopedElementsMixin(DBPCabinetLitElement) {
    constructor() {
        super();
    ...
    saveRequest() {
        ...
        this.getCreatedCabinetRequests().then(() => {
            ...
            <div class="${classMap({hidden: !this.isLoggedIn() || this.isLoading() || this.loadingTranslations})}">
                ...
                <div class="no-access-notification">
                    <dbp-inline-notification class="${classMap({ hidden: !this.isLoggedIn() || this.isLoading() || this.mayWrite || this.requestCreated || !this.organizationLoaded })}"
                                             type="danger"
                                             body="${this.mayRead || this.mayReadMetadata ? i18n.t('create-request.error-no-writes') : i18n.t('error-no-read')}">
                    </dbp-inline-notification>
                </div>
                ...
                <div class="back-container">
                    ...
                    <span class="back-navigation ${classMap({hidden: !this.isLoggedIn() || this.isLoading() || !this.requestCreated || this.singleFileProcessing || this.showListView })}">
                        <a href="#" title="${i18n.t('show-requests.back-to-list')}"
                           @click="${(e) => {
                               this.getCreatedCabinetRequests();
                               this.showDetailsView = false;
                               this.showListView = true;
                               this.subject = '';
                           }}"
                ...
                <h3 class="${classMap({hidden: !this.isLoggedIn() || this.isLoading() || !this.showDetailsView })}">
                    ${i18n.t('create-request.create-cabinet-order')}:
                </h3>
                ...
                <div class="${classMap({hidden: !this.isLoggedIn() || this.isLoading() || this.showDetailsView || !this.showListView })}">
                    <div class="table-wrapper">
                        ...
                        <div class="cabinet-table ${classMap({hidden: !this.isLoggedIn() || this.isLoading() || this.showDetailsView || !this.showListView || this.createRequestsLoading || this.tableLoading })}">
